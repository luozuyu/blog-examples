...
# 域名解析
vi /etc/hosts
	192.168.184.101 node01
	192.168.184.102 node02
	192.168.184.103 node03
vi /etc/hostname ...

# 环境变量
vi /etc/profile
  export JAVA_HOME=/home/wesharecn/jdk1.8.0_241
  export HADOOP_HOME=/home/wesharecn/hadoop-2.4.1
...
ssh-keygen -t rsa
ssh-copy-id node01/node02/node03

# 格式化并启动集群
hadoop namenode -format
start-all.sh（start-dfs.sh、start-yarn.sh）
http://node01:50070 http://node03:8088

# MR测试
hadoop jar $HADOOP_HOME/share/hadoop/mapreduce/hadoop-mapreduce-examples-2.4.1.jar pi 2 2
```
...
```xml
# 解压
	curl -O http://archive.apache.org/dist/hbase/0.98.24 && tar -zxvf hbase-0.98.24-bin.tar.gz

# 环境变量
	vi /etc/profile
		export HBASE_HOME=/home/wesharecn/hbase-0.98.24
...
# 启动集群
hdfs... zookeeper... start-hbase.sh http://hadoop-master:60010
```
